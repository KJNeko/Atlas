...
from core.Hydrus95Globals import *

STYLESHEET_DIR = os.path.join( RESOURCE_DIR, 'qss' )
...
def InitialiseDefaults():
    ...
    try:
        ...
        with open( os.path.join( STYLESHEET_DIR, 'OledBlack.qss' ), 'r', encoding = 'utf-8' ) as f:
    ...
    QW.QApplication.instance().setStyle( CURRENT_STYLESHEET )
