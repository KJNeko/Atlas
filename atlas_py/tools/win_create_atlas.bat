...
pyinstaller  --onedir --windowed --add-data "../atlas/assets/themes;./Resources/themes" --icon="../atlas/assets/icons/appicon.ico" --name="Atlas" "../atlas/main.py" --noconfirm --distpath="dist"
