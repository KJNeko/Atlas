...
class SettingsDialog final : public QDialog
{
  ...
  private slots:
	...
	void on_cb_title_align_stateChanged( int state );
	...
	void on_cb_engine_align_stateChanged( int state );
	...
	void on_cb_version_align_stateChanged( int state );
	...
	void on_cb_creator_align_stateChanged( int state );
	...
	void on_cb_rating_link_stateChanged( int state );
	//Views
	...
	void on_cb_views_align_stateChanged( int state );
	void on_cb_views_link_stateChanged( int state );
	//Likes
	...
	void on_cb_likes_align_stateChanged( int state );
	void on_cb_likes_link_stateChanged( int state );
	//Favorite
	...
	void on_cb_favorite_align_stateChanged( int state );
	void on_cb_favorite_link_stateChanged( int state );
	//UpdateIcon
