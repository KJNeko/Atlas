...
//Images
SETTINGS_DE( grid_ui, imageLayout, SCALE_TYPE, KEEP_ASPECT_RATIO_BY_EXPANDING ) // Default is keep aspect ratio
...
SETTINGS_D( grid_ui, font_size, int, 11 )
SETTINGS_D( grid_ui, font_bold, bool, true )
SETTINGS_D( grid_ui, font_italic, bool, false )
SETTINGS_D( grid_ui, font_shadow, bool, true )
SETTINGS_D( grid_ui, padding, int, 4 )
SETTINGS_D( grid_ui, corner_radius, int, 2 )
...
SETTINGS_D( grid_ui, title_y, int, 228 )
...
SETTINGS_D( grid_ui, title_font_size, int, 14 )
SETTINGS_D( grid_ui, title_link, int, DISABLED )
//ENGINE
SETTINGS_D( grid_ui, engine_enable, bool, true )
SETTINGS_D( grid_ui, engine_x, int, 10 )
SETTINGS_D( grid_ui, engine_y, int, 230 )
...
SETTINGS_D( grid_ui, version_y, int, 6 )
...
SETTINGS_D( grid_ui, creator_y, int, 6 )
...
//STATUS
SETTINGS_D( grid_ui, status_enable, bool, false )
SETTINGS_D( grid_ui, status_x, int, 527 )
SETTINGS_D( grid_ui, status_y, int, 230 )
...
//GAME TYPE
SETTINGS_D( grid_ui, gametype_enable, bool, false )
SETTINGS_D( grid_ui, gametype_x, int, 10 )
SETTINGS_D( grid_ui, gametype_y, int, 206 )
...
//RATING
SETTINGS_D( grid_ui, rating_enable, bool, false )
SETTINGS_D( grid_ui, rating_x, int, 320 )
SETTINGS_D( grid_ui, rating_y, int, 6 )
...
//VIEWS
SETTINGS_D( grid_ui, views_enable, bool, false )
SETTINGS_D( grid_ui, views_x, int, 220 )
SETTINGS_D( grid_ui, views_y, int, 6 )
...
//LIKES
SETTINGS_D( grid_ui, likes_enable, bool, false )
SETTINGS_D( grid_ui, likes_x, int, 270 )
SETTINGS_D( grid_ui, likes_y, int, 6 )
...
//FAVORITE
SETTINGS_D( grid_ui, favorite_enable, bool, false )
SETTINGS_D( grid_ui, favorite_x, int, 500 )
SETTINGS_D( grid_ui, favorite_y, int, 205 )
SETTINGS_D( grid_ui, favorite_align, int, RIGHT )
...
//UPDATE ICON
SETTINGS_D( grid_ui, updateicon_enable, bool, false )
