...
SETTINGS_D( grid_ui, title_link, Link, DISABLED )
//ENGINE
...
SETTINGS_D( grid_ui, engine_link, Link, DISABLED )
//VERSION
...
SETTINGS_D( grid_ui, version_link, Link, DISABLED )
...
SETTINGS_D( grid_ui, creator_link, Link, DISABLED )
//STATUS
